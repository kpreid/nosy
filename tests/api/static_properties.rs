...
const _: () = {
    ...
    assert_not_impl_any!(nosy::Buffer<'static, (), nosy::unsync::DynListener<()>, 1>: Send, Sync);
    #[cfg(feature = "sync")]
    {
        ...
        assert_not_impl_any!(
            nosy::Buffer<'static, *const (), nosy::sync::DynListener<*const ()>, 1>: Send, Sync
        );
    }

    assert_impl_all!(nosy::Filter<fn(()) -> Option<()>, (), 1>: Send, Sync, Unpin, RefUnwindSafe, UnwindSafe);

    assert_impl_all!(nosy::Flag: Send, Sync, Unpin, RefUnwindSafe, UnwindSafe);
    assert_impl_all!(nosy::FlagListener: Send, Sync, Unpin, RefUnwindSafe, UnwindSafe);

    assert_impl_all!(nosy::Gate: Send, Sync, Unpin, RefUnwindSafe, UnwindSafe);
    assert_impl_all!(nosy::GateListener<nosy::FlagListener>: Send, Sync, Unpin, RefUnwindSafe, UnwindSafe);
    ...
    assert_impl_all!(nosy::unsync::NotifierForwarder<()>: Unpin);
    ...
    #[cfg(feature = "sync")]
    {
        assert_impl_all!(nosy::sync::NotifierForwarder<()>: Send, Sync, Unpin);
        assert_impl_all!(nosy::sync::NotifierForwarder<*const ()>: Send, Sync);
    }

    assert_impl_all!(nosy::NullListener: Send, Sync, Copy, RefUnwindSafe, UnwindSafe);
